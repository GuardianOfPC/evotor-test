...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Override public AuthenticationResponse register(RegisterRequest request) {
    ...
    @Override public AuthenticationResponse authenticate(AuthenticationRequest request) {
